...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
     <p align="center">Untuk melakukan reset password, silakan masukkan alamat email anda. </p>
     ...
     <div class="form-group has-feedback">
      <!-- <input type="text" name="username" class="form-control" placeholder="Username" autofocus="true"> -->
       ...
       <input type="text" name="email" class="form-control" placeholder="email@example.com" value="<?php echo set_value('email'); ?>" />
    ...
    <div>
      <p>
        <?php 
        echo anchor(site_url() . 'login/index', 'Halaman Login');
        ?>
      </p> 
    </div>
